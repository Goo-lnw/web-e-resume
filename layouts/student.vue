        ...
        <nav class="text-white shadow-sm fixed top-0 left-0 right-0 z-50 animate-fade-fade-down bg-white/95 backdrop-blur-sm">
            <div class="flex justify-center gap-2 items-center w-full">
                ...
                <div class="group relative flex flex-col items-center justify-center">
                    ...
                    >
                        <Icon name="uil:comment-plus" style="height: 24px; width: 24px" class="sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-gray-600 group-hover:text-blue-600 transition-colors duration-200" />
                        <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-blue-400 group-hover:w-full transition-all duration-300 ease-out"></div>
                        <!-- Tooltip -->
                        <div
                            class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
                    ...
                    <!-- Dropdown Menu -->
                    <div v-if="isDesktopDropdownOpen" class="absolute top-12 left-1/2 transform -translate-x-1/2 bg-white shadow-lg rounded-md z-50 border border-gray-200 min-w-48">
                ...
                <div class="group relative flex flex-col items-center justify-center">
                    <button
                        ...
                        class="flex flex-col items-center justify-center p-2 lg:p-3 rounded-lg transition-all duration-200 ease-in-out hover:bg-gray-100 active:bg-gray-200 cursor-pointer"
                    >
                        <Icon name="mdi:account-reactivate" style="height: 24px; width: 24px" class="sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-gray-600 group-hover:text-blue-600 transition-colors duration-200" />
                        <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-blue-400 group-hover:w-full transition-all duration-300 ease-out"></div>
                        <!-- Tooltip -->
                        <div
                            class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
                    ...
                    <div v-if="isProfileDropdownOpen" class="absolute top-12 right-0 bg-white shadow-lg rounded-md z-50 border border-gray-200 min-w-48">
                        <ul class="text-sm text-gray-800 py-1">
                            <li>
                                <NuxtLink to="/student/edit_profile" class="block px-4 py-2 w-full text-left hover:bg-gray-100 transition-colors duration-200" @click="isProfileDropdownOpen = false">
