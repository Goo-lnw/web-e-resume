            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-2 py-2 md:px-6 md:py-4 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-sm mt-1">จัดการทักษะเฉพาะทางของคุณ</p>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center space-x-1 md:space-x-2 mb-3">
                                ...
                                <button @click="removeSkill(skill.skill_id)" class="p-1 text-red-500 hover:text-red-700 hover:bg-red-50 rounded transition-all duration-300 cursor-pointer transform hover:scale-120 ease-in-out" title="Remove skill">
                        ...
                        <div class="mt-4">
                            <div class="flex items-center space-x-3">
                                <span class="text-sm text-gray-600">ความเชียวชาญ</span>
                    ...
                    >
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <h3 class="text-xs md:text-md font-semibold text-green-800 mb-2">เพิ่มทักษะ</h3>
                    ...
                    <div v-if="isLoading" class="flex flex-col items-center justify-center py-12">
                        ...
                        <p class="text-gray-500 text-lg">กำลังโหลดทักษะของคุณ...</p>
