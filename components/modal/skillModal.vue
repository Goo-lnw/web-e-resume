      ...
      >
        <div class="space-y-2">
                ...
                >
                  {{
                    skill.skill_proficiency
                      ? $t("skill_modal.proficiency_" + skill.skill_proficiency)
                      : $t("skill_modal.proficiency_not_set")
                  }}
                </span>
                <button
            ...
            <div class="mt-4">
              <div class="flex items-center space-x-3">
                <span class="text-sm text-gray-600">{{
                  $t("skill_modal.proficiency_label")
                }}</span>
          ...
          >
            ...
            ></div>
            <p class="text-gray-500 text-lg">{{ $t("skill_modal.loading") }}</p>
