        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-2 py-2 md:px-6 md:py-4 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-md md:text-2xl font-bold">ผลงานอื่นๆ</h2>
                        <p class="text-blue-100 text-sm mt-1">จัดการรายละเอียดและความสำเร็จเพิ่มเติมของคุณ</p>
                    </div>
                ...
                <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3 min-w-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-nowrap text-gray-500">จัดการผลงานอื่นๆของคุณ</p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    type="text"
                                    placeholder="เชื่น ผลงานหรือความสำเร็จ"
                            ...
                            <div class="space-y-2 lg:col-span-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center space-x-2">
                                    ...
                                    <span>รายละเอียดผลงาน</span>
                                </label>
                                <textarea
                                    v-model="info.additional_info_description"
                                    placeholder="รายละเอียดเพิ่มเติมเกี่ยวกับผลงานหรือความสำเร็จของคุณ"
                                    class="w-full text-xs px-2 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white hover:border-gray-400"
                                    rows="4"
                                ></textarea>
                            </div>
                    ...
                    >
                        <div class="flex flex-col items-center justify-center text-center">
                            ...
                            <h3 class="text-lg font-semibold text-green-800 mb-2">เพิ่มผลงานเพิ่มเติม</h3>
                            <p class="text-green-600 text-sm">คลิกเพื่อเพิ่มใหม่</p>
                        </div>
                    </div>
                    ...
                    <div v-if="isLoading" class="flex flex-col items-center justify-center py-12">
                        ...
                        <p class="text-gray-500 text-lg">กำลังโหลดผลงานของคุณ...</p>
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-500">ผลงานทั้งหมด {{ additionalInfoData.length }} ผลงาน</div>
