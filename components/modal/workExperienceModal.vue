            ...
            <div class="bg-gray-50 px-2 py-2 md:px-6 md:py-4 border-t border-gray-200 space-y-1">
                ...
                <div class="flex justify-end space-x-3">
                    <button
                        @click="close"
                        :disabled="isSaving"
                        class="px-2 py-2 md:px-3 text-xs border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        :disabled="isSaving"
                        class="px-2 py-2 2 md:px-3 text-xs bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 font-medium shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 cursor-pointer"
                    >
