        ...
        <div class="flex justify-between items-center">
          ...
          <div class="space-x-3">
            <button
              @click="saveEducation"
              :disabled="isSaving"
              class="px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
...
const saveEducation = async () => {
  try {
    ...
    for (const education of educationData.value) {
      await $axios.put(`/resume/education-history/${education.education_history_id}`, {
