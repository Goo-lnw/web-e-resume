          ...
          >
            ...
            <div class="flex items-center justify-between mb-4">
              ...
              <div class="flex items-center space-x-1 md:space-x-2 mb-3">
                ...
                <button @click="removeSoftSkill(index)" class="p-1 text-red-500 hover:text-red-700 hover:bg-red-50 rounded transition-all duration-300 cursor-pointer transform hover:scale-120 ease-in-out" :title="$t('soft_skill_modal.remove_soft_skill')">
                ...
                <span class="text-xs text-gray-500">
                  {{
                    softSkill.soft_skill_name && softSkill.soft_skill_description
                      ? $t('soft_skill_modal.complete')
                      : softSkill.soft_skill_name
                        ? $t('soft_skill_modal.partial')
                        : $t('soft_skill_modal.incomplete')
                  }}
                </span>
              </div>
            </div>
