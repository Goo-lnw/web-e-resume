    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      >
        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
          ...
          >
            ...
            quo ab sed voluptatibus sapiente aliquid omnis molestias obcaecati
            repudiandae ipsum facilis ea similique, laboriosam incidunt eum esse
        ...
        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
          ...
          >
            <img
              src="../../assets/images/bru-web-logo-en.png"
              alt=""
              class="h-26"
            />
          </a>
        ...
        <div class="lg:mx-auto text-left">
          ...
          <ul class="text-sm transition-all duration-500">
            ...
            <li class="mb-6">
              <NuxtLink href="/" class="text-gray-600 hover:text-gray-900"
        ...
        <div class="lg:mx-auto text-left">
          ...
          <ul class="text-sm transition-all duration-500">
            ...
            <li class="mb-6">
              <NuxtLink href="https://it.bru.ac.th/" class="text-gray-600 hover:text-gray-900"
                >เว็บไซต์</NuxtLink
              >
            </li>
          </ul>
      ...
      <div class="flex mb-4 space-x-4 sm:justify-between lg:mt-0">
        ...
        <div class="flex gap-2 flex-row lg:flex-row items-center">
          ...
          <NuxtLink
            href="https://www.youtube.com/watch?v=vqTh3UkZZBk"
      ...
      <!--Grid-->
      <div class="py-7 border-t border-gray-200"></div>
    </div>
  </footer>
</template>
