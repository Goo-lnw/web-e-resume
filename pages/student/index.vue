        ...
        <div v-else class="max-w-7xl mx-auto px-1 sm:px-2 md:px-4">
            <div class="" style="min-height: 11in">
                ...
                <div class="p-2 sm:p-4 md:p-6 lg:p-12">
                    ...
                    <div class="text-center bg-white border-gray-800 pb-4 lg:pb-2 mb-2 lg:mb-4 shadow-lg rounded p-2 sm:p-4">
                        <div class="flex flex-col sm:flex-row items-center mb-3 lg:mb-4 gap-2 sm:gap-4">
                            ...
                            <div class="text-start w-full">
                                ...
                                <div v-if="resumeStore.student.student_email" class="flex items-center text-xs sm:text-sm text-gray-900 mb-2 sm:mb-3">
                                    ...
                                    อีเมลล์ {{ resumeStore.student.student_email }}
                                </div>
                                <div v-if="resumeStore.student.student_phone" class="flex items-center text-xs sm:text-sm text-gray-900 mb-2 sm:mb-3">
                                    ...
                                    เบอร์โทรศัพท์: {{ resumeStore.student.student_phone }}
                                </div>
                                <div v-if="resumeStore.student.student_main_id" class="flex items-center text-xs sm:text-sm text-gray-900 mb-2 sm:mb-3">
                                    ...
                                    รหัสประจำตัว: {{ resumeStore.student.student_main_id }}
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        <div class="lg:col-span-1 space-y-3 sm:space-y-4 lg:space-y-6">
                            ...
                            <div class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base text-shadow-sm text-blue-800 lg:text-lg font-bold mb-2 lg:mb-3 pb-1 border-b border-gray-400 uppercase tracking-wide">Personal Information</h2>
                                <div class="border-l-4 border-blue-600 pl-3 sm:pl-4 space-y-2 text-xs sm:text-sm">
                                    ...
                                    <div v-if="resumeStore.student.address" class="mt-3">
                                        <span class="text-gray-600 block mb-1 font-bold">Address:</span>
                            ...
                            <!-- Contact & Social -->
                            <div v-if="resumeStore.student.facebook || resumeStore.student.line" class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg text-shadow-sm font-bold text-green-600 mb-2 lg:mb-3 pb-1 border-b border-gray-400 uppercase tracking-wide">Social Media</h2>
                            ...
                            <!-- Hobbies & Interests -->
                            <div v-if="resumeStore.student.hobby" class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-yellow-500 mb-2 lg:mb-3 pb-1 border-b border-gray-400 uppercase tracking-wide">Hobbies & Interests</h2>
                            ...
                            <!-- Technical Skills -->
                            <div class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-shadow-sm text-blue-800 mb-2 lg:mb-3 pb-1 border-b border-gray-400 uppercase tracking-wide">Technical Skills</h2>
                                <div class="space-y-2">
                            ...
                            <!-- Soft Skills -->
                            <div class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-shadow-sm text-violet-800 mb-2 lg:mb-3 pb-1 border-b border-gray-400 uppercase tracking-wide">Soft Skills</h2>
                            ...
                            <!-- Education -->
                            <div class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-indigo-800 mb-2 lg:mb-3 pb-1 border-b border-gray-400 uppercase tracking-wide">Education</h2>
                        ...
                        <div class="lg:col-span-2 space-y-3 sm:space-y-4 lg:space-y-6">
                            <!-- Work Experience -->
                            <div class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-blue-800 text-shadow-sm mb-3 lg:mb-4 pb-1 border-b border-gray-400 uppercase tracking-wide">Professional Experience</h2>
                            ...
                            <!-- Internships -->
                            <div v-if="resumeStore.internships?.length" class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-shadow-sm text-orange-800 mb-3 lg:mb-4 pb-1 border-b border-gray-400 uppercase tracking-wide">Internships</h2>
                            ...
                            <!-- Projects -->
                            <div class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-gray-900 mb-3 lg:mb-4 pb-1 border-b border-gray-400 uppercase tracking-wide">Projects</h2>
                                <div class="space-y-3 lg:space-y-4">
                                    <div v-for="project in resumeStore.projects" :key="project.project_name">
                                        <div class="border border-gray-200 rounded-lg p-2 sm:p-4 flex flex-col sm:flex-row sm:justify-between sm:items-start mb-1 space-y-1 sm:space-y-0">
                            ...
                            <!-- Training -->
                            <div v-if="resumeStore.training?.length" class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-yellow-700 mb-3 lg:mb-4 pb-1 border-b border-gray-400 uppercase tracking-wide">Training & Certifications</h2>
                                <div class="space-y-2 lg:space-y-3">
                                    <div v-for="training in resumeStore.training" :key="training.training_history_course_id">
                                        ...
                                        <div v-if="training.training_history_certificate_file" class="mt-1">
                                            <a :href="training.training_history_certificate_file" target="_blank" class="text-xs text-blue-600 underline hover:text-blue-800 self-start sm:self-auto hover:scale-105 transition-all duration-200 ease-in-out">
                                                View Certificate →
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <!-- Additional Info -->
                            <div v-if="resumeStore.additionalInfo?.length" class="bg-white shadow-lg rounded-lg p-3 sm:p-6">
                                <h2 class="text-base lg:text-lg font-bold text-yellow-700 mb-3 lg:mb-4 pb-1 border-b border-gray-400 uppercase tracking-wide">Additional Information</h2>
                                <div class="space-y-2 lg:space-y-3">
                                    <div v-for="info in resumeStore.additionalInfo" :key="info.additional_info_id">
                                        ...
                                        <div v-if="info.additional_info_file_attachment" class="mt-1">
                                            <a :href="info.additional_info_file_attachment" target="_blank" class="text-xs text-blue-600 underline hover:text-blue-800 self-start sm:self-auto hover:scale-105 transition-all duration-200 ease-in-out">
                                                View Resource →
                                            </a>
                                        </div>
                                    </div>
