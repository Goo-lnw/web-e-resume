  ...
  <div class="container min-h-screen p-2 sm:p-4 rounded bg-gray-100">
    ...
    <div class="flex justify-center items-center text-xl sm:text-2xl lg:text-3xl mb-4 sm:mb-">
      <h1 class="text-center font-semibold text-gray-800">
        รายการแสดง Resume นักศึกษา/นักเรียน
      </h1>
    </div>
    <!-- 2. Search Section -->
    <div class="mb-4 sm:mb-6">
      <div class="flex items-center w-full max-w-d mx-auto">
        <div class="relative w-full">
          <input type="text" v-model="search" placeholder="ค้นหานักเรียน/นักศึกษา..."
    ...
    <div class="max-w-7xl mx-auto sm:px-4 px-2">
      <div class="grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6">
        ...
        <!-- 5. Center content -->
        <div class="lg:col-span-2 xl:col-span-3 order-1 lg:order-2 space-y-4 sm:space-y-6">
          <div
            ...
            v-for="(item, index) in filteredResume" :key="index">
            <!-- 6. User Header -->
            ...
            <!-- 7. Resume Content -->
            <div class="text-gray-800 p-4 sm:p-6 hover:bg-gray-50 transition-colors duration-200"
            ...
            <div class="border-t border-gray-100">
              <div class="flex">
                <button @click="likeHendler(item.resume.resume_id)"
                  ...
                  <Icon v-if="item.resume.resume_follow_resume === '1'" name="material-symbols:favorite"
                    style="color: red" />
