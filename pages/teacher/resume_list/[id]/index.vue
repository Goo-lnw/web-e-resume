    ...
    <div v-else class="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div class="bg-white shadow-lg rounded-lg p-6">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
          <div
            ...
            <NuxtImg v-if="resume.student?.student_profile_image" :src="resume.student.student_profile_image"
              :alt="`${resume.student?.student_name} Profile`" class="w-full h-full object-cover" />
          ...
          <div class="flex-1 text-center md:text-left">
            ...
            <p class="text-gray-600 mb-2">
              ID: {{ resume.student?.student_main_id || "N/A" }}
            </p>
            ...
            <div class="mb-4">
              ...
              <div class="text-sm text-gray-500 mt-2">
                ...
                <p v-if="resume.resume?.approved_at">
                  Approved: {{ formatDate(resume.resume?.approved_at) }}
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="space-y-3">
              <div class="flex items-center gap-2">
                ...
                <span class="text-gray-700">{{
                  resume.student?.student_email || "N/A"
                }}</span>
              </div>
              <div class="flex items-center gap-2">
                <span class="text-blue-500">📞</span>
                <span class="text-gray-700">{{
                  resume.student?.student_phone || "N/A"
                }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-4">
              <div v-for="(skill, index) in resume.skills?.filter(
                (s) => s.skill_name
                ...
                <div class="flex items-center gap-2">
                  <div class="flex-1 bg-gray-200 rounded-full h-2">
                    <div class="h-2 rounded-full transition-all duration-300"
                      :class="getProficiencyColor(skill.skill_proficiency)"></div>
                  </div>
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-3">
              <div v-for="(softSkill, index) in resume.softSkills?.filter(
                (s) => s.soft_skill_name
              )" :key="index">
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-3">
              <div v-for="(info, index) in resume.additionalInfo?.filter(
                ...
                <a v-if="info.additional_info_file_attachment" :href="info.additional_info_file_attachment"
                  target="_blank" class="text-blue-500 hover:text-blue-700 text-sm underline">
                  View Attachment
                </a>
              </div>
              <p v-if="
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-4">
              <div v-for="(work, index) in resume.workExperience?.filter(
                (w) => w.work_experience_company_name
              )" :key="index" class="border-l-4 border-orange-400 pl-4 py-2">
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="grid gap-4">
              <div v-for="(project, index) in resume.projects?.filter(
                (p) => p.project_name
              )" :key="index" class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                  <h3 class="font-semibold text-gray-800">
                    {{ project.project_name }}
                  </h3>
                  <a v-if="project.project_attachment_link" :href="project.project_attachment_link" target="_blank"
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-4">
              <div v-for="(edu, index) in resume.education?.filter(
                (e) => e.education_history_institution
              )" :key="index" class="border-l-4 border-indigo-400 pl-4 py-2">
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-4">
              <div v-for="(training, index) in resume.training?.filter(
                (t) => t.training_history_course_name
              )" :key="index" class="border border-gray-200 rounded-lg p-4">
                ...
                <button v-if="training.training_history_certificate_file" @click="viewCertificate(training)"
                  class="text-blue-500 hover:text-blue-700 text-sm underline" style="
                    background: none;
                    border: none;
                    padding: 0;
                    cursor: pointer;
          ...
          <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-4">
              <div v-for="(internship, index) in resume.internships?.filter(
                (i) => i.internship_company_name
              )" :key="index" class="border-l-4 border-teal-400 pl-4 py-2">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                  <div>
                    <h3 class="font-semibold text-gray-800">
                ...
                <a v-if="internship.internship_related_files" :href="internship.internship_related_files"
                  target="_blank" class="text-blue-500 hover:text-blue-700 text-sm underline">
                  View Related Files
                </a>
              </div>
      ...
      <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <form @submit.prevent="updateComment" class="space-y-4">
          <div>
            ...
            <textarea v-model="formComment.resume_teacher_comment" rows="4"
              class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-y"
              placeholder="Enter your evaluation comments..."></textarea>
          </div>

          <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            <div class="flex gap-6">
              <label class="flex items-center gap-2 cursor-pointer">
                <input v-model="formComment.resume_status" type="radio" value="3"
              ...
              <label class="flex items-center gap-2 cursor-pointer">
                <input v-model="formComment.resume_status" type="radio" value="4"
      ...
      <div class="text-center text-white text-sm p-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg">
        <div class="flex justify-center items-center gap-4">
          <p>
            © 2024 {{ resume.student?.student_name || "Student" }} -
            Professional Resume
          </p>
